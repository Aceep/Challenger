...
export const ORGANIZER_STEPS: GuideStep[] = [
  ...
  },
  {
    ...
    lines: [
      "Personne ne rejoint un défi tout seul : c’est toujours l’organisation qui invite. Cela se passe dans **Joueurs**, sur le site.",
      "Une invitation se pose sur un **identifiant Discord** — la suite de chiffres que l’on copie avec un clic droit sur la personne, une fois le *mode développeur* activé dans les réglages avancés de Discord.",
      "Choisis son équipe et son rôle, puis valide. L’invitation s’applique à sa **prochaine connexion** au site : si la personne est déjà connectée, elle se déconnecte et se reconnecte.",
      "Une invitation posée avant la première connexion fonctionne tout aussi bien : elle attend.",
    ],
  },
  {
    id: "regler-le-jeu",
...
export const PLAYER_STEPS: GuideStep[] = [
  {
    ...
    lines: [
      ...
      "Va sur le site, clique sur **Se connecter avec Discord**, autorise l’application : ton édition et ton équipe sont déjà choisies.",
      "Si tu étais déjà connecté·e au moment de l’invitation, déconnecte-toi et reconnecte-toi : l’invitation s’applique à la connexion suivante.",
