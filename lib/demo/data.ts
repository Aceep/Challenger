...
export const DEMO_BOOKS: (BookRow & { userId: string })[] = [
  {
    ...
    points: 51.2,
    coverUrl: "https://covers.openlibrary.org/b/id/9157544-M.jpg",
    owner: "Léa",
    editable: true,
  ...
  },
  {
    ...
    points: 70.4,
    coverUrl: "https://covers.openlibrary.org/b/id/10675378-M.jpg",
    owner: "Léa",
    editable: false,
    editUntil: null,
    questNumber: null,
...
export const DEMO_READINGS_ADMIN: (AdminReadingRow & { userId: string; teamId: string; declaredGraphic: boolean; questId: string; cellId: string })[] = [
  ...
  },
  {
    ...
    points: 37.2,
    coverUrl: "https://covers.openlibrary.org/b/id/12648921-M.jpg",
    questNumber: null,
    questHalf: true,
    questId: "",
    cellLabel: "A1",
