...
import { pinAction, replyAction, resolveAction } from "../actions";
...
export default async function QuestionPage({ params, searchParams }: PageProps<"/faq/[id]">) {
  ...
  return <QuestionView question={question} params={sp} replyAction={replyAction} resolveAction={resolveAction} pinAction={pinAction} />;
}
